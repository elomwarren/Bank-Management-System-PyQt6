...
class cards(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('D:/01_IPMC/01_SEMESTER1/08_PROJECT_WORK/02_PROJECT/01_PROJECT_PAPER/GUI/VVBank_GUIProject_PyQt6/assets/credit-card.png'))
    ...
    def initUI(self):
        ...
        # Card ID field
        cardIDField = QLineEdit()

        # Card Number field
        cardNumField = QLineEdit()

        # Card Type field
        cardTypeField = QLineEdit()

        # Card Limit field
        cardLimitField = QLineEdit()

        # Card Creation Date field
        dateCreatField = QLineEdit()

        # Card expiry Date field
        dateExpiryField = QLineEdit()

        # Card Status Field
        cardStatusField = QLineEdit()
        ...
        NewForm.addRow('Card ID', cardIDField)
        NewForm.addRow('Card Number', cardNumField)
        NewForm.addRow('Card Type', cardTypeField)
        NewForm.addRow('Card Limit', cardLimitField)
        NewForm.addRow('Creation Date', dateCreatField)
        NewForm.addRow('Expiry', dateExpiryField)
