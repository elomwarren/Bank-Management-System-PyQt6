...
class jobs(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('D:/01_IPMC/01_SEMESTER1/08_PROJECT_WORK/02_PROJECT/01_PROJECT_PAPER/GUI/VVBank_GUIProject_PyQt6/assets/job.png'))
    ...
    def initUI(self):
        ...
        # Job Title field
        jobTitleField = QLineEdit()

        # Miinimum Salary field
        minSalaryField = QLineEdit()

        # Maximum Salary field
        maxSalaryField = QLineEdit()
        ...
        NewForm.addRow('Job Title', jobTitleField)
        NewForm.addRow('Minimum Salary', minSalaryField)
        NewForm.addRow('Maximum Salary', maxSalaryField)
