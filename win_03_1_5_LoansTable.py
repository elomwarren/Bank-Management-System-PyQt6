...
class loans(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('D:/01_IPMC/01_SEMESTER1/08_PROJECT_WORK/02_PROJECT/01_PROJECT_PAPER/GUI/VVBank_GUIProject_PyQt6/assets/loan.png'))
    ...
    def initUI(self):
        ...
        # Loan Amount field
        lnAmountField = QLineEdit()

        # Loan Date field
        lnDateField = QLineEdit()

        # Customer ID Field
        customerIDField = QLineEdit()
        ...
        NewForm.addRow('Loan ID', lnIDField)
        NewForm.addRow('Amount', lnAmountField)
        NewForm.addRow('Date', lnDateField)
        NewForm.addRow('Customer ID', customerIDField)
