...
class locations(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QIcon('D:/01_IPMC/01_SEMESTER1/08_PROJECT_WORK/02_PROJECT/01_PROJECT_PAPER/GUI/VVBank_GUIProject_PyQt6/assets/location.png'))
    ...
    def initUI(self):
        ...
        # Location ID field
        locIDField = QLineEdit()

        # Street Address field
        strAddrField = QLineEdit()

        # Postcode field
        postcodeField = QLineEdit()

        # Digital Address field
        digiAddrField = QLineEdit()
        ...
        NewForm.addRow('Location ID', locIDField)
        NewForm.addRow('Street Address', strAddrField)
        NewForm.addRow('Postcode', postcodeField)
        NewForm.addRow('Digital Address', digiAddrField)
